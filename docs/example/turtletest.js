...
let degrees = 120;
let branches = 2;
let rotation = degrees / (branches);
let lengthMultiplier = 20;
function traverseTree(depth) {
    if (depth <= 0)
        return;
...
function createTree(branches, depth) {
    if (depth <= 0)
        return;
...
function circle(radius = 100, steps = 360, clockwise = true) {
...
//# sourceMappingURL=turtletest.js.map